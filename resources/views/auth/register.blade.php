                        ...
                        <form method="post" action="{{ route('register') }}">
                          ...
                          <div class="form-group">
                           <div class="position-relative has-icon-left">
                              ...
                              <input name="name" type="text" id="exampleInputName" class="form-control" placeholder="Name">
                          ...
                          <div class="form-group">
                           <div class="position-relative has-icon-left">
                              ...
                              <input name="password" type="text" id="exampleInputPassword" class="form-control" placeholder="Password">
                              <div class="form-control-position">
                                  <i class="icon-lock"></i>
                              </div>
                           </div>
