                     ...
                     <div class="card-title text-uppercase text-center py-3">Sign In</div>
                      ...
                      <center>
                       <form method="POST" action="{{ route('login') }}">
                        @csrf
                          <div class="form-group">
                           <div class="position-relative has-icon-left">
                               <label for="exampleInputUsername" class="sr-only ">Username</label>
                                 <input name="email" type="text" id="exampleInputUsername" class="form-control" placeholder="Username" style="width:600px "  >
                          ...
                          <div class="form-group">
                           <div class="position-relative has-icon-left">
                              ...
                              <input type="password" name="password" id="exampleInputPassword" class="form-control" placeholder="Password" style="width:600px "  >
                              <div class="form-control-position">
                                  <i class="icon-lock"></i>
                              </div>
                           </div>
                        ...
                        <button type="submit" class="btn btn-outline-facebook btn-block waves-effect waves-light " style="width:200px "  >Sign In</button>
